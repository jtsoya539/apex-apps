...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56882920378266342522)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882920667127342522)
,p_plug_template_id=>wwv_flow_api.id(56882920378266342522)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882920952352342522)
,p_plug_template_id=>wwv_flow_api.id(56882920378266342522)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882921208818342523)
,p_plug_template_id=>wwv_flow_api.id(56882920378266342522)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882921559227342523)
,p_plug_template_id=>wwv_flow_api.id(56882920378266342522)
,p_name=>'Sub Regions'
