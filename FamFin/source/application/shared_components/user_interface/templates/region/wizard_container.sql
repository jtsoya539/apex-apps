...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56882959360480342536)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882959635576342536)
,p_plug_template_id=>wwv_flow_api.id(56882959360480342536)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882959937825342536)
,p_plug_template_id=>wwv_flow_api.id(56882959360480342536)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882960268598342536)
,p_plug_template_id=>wwv_flow_api.id(56882959360480342536)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882960576431342537)
,p_plug_template_id=>wwv_flow_api.id(56882959360480342536)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882960884624342537)
,p_plug_template_id=>wwv_flow_api.id(56882959360480342536)
