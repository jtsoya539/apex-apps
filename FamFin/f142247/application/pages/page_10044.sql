...
,p_last_upd_yyyymmddhh24miss=>'20220415002922'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(708649923062684984)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(708650012385684984)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(708650214657684984)
,p_name=>'Exceptions'
,p_parent_plug_id=>wwv_flow_imp.id(708650012385684984)
,p_template=>wwv_flow_imp.id(708384702112684467)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(708657301572684989)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(708657781054684990)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(708650382030684984)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(708650401090684984)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(708660746996685125)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(708661415076685126)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(708650510301684984)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(708649923062684984)
,p_button_name=>'SUBMIT'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(708499111361684511)
,p_button_is_hot=>'Y'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(708662121959685127)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(708662590930685127)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(708649923062684984)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(708663878678685128)
,p_name=>'P10044_ROLE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(708650401090684984)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(708664282228685128)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(708664611828685128)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(708662698890685127)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(708662590930685127)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(708663334419685127)
,p_event_id=>wwv_flow_imp.id(708662698890685127)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(708665082054685128)
...
,p_process_when_button_id=>wwv_flow_imp.id(708650510301684984)
,p_process_success_message=>'User(s) added.'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(708665435660685129)
