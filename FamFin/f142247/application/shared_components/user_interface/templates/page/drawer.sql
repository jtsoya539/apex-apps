...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(708329992075684444)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708330224031684445)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708330548824684445)
,p_page_template_id=>wwv_flow_imp.id(708329992075684444)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708330817254684445)
,p_page_template_id=>wwv_flow_imp.id(708329992075684444)
