...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(708359114834684457)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708359452579684457)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708359782434684457)
,p_page_template_id=>wwv_flow_imp.id(708359114834684457)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708360026800684457)
,p_page_template_id=>wwv_flow_imp.id(708359114834684457)
