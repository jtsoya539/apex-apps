...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(708372971294684462)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708373267423684463)
,p_plug_template_id=>wwv_flow_imp.id(708372971294684462)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708373519984684463)
,p_plug_template_id=>wwv_flow_imp.id(708372971294684462)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708373854922684463)
,p_plug_template_id=>wwv_flow_imp.id(708372971294684462)
,p_name=>'Sub Regions'
