...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(708360680175684458)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708360905482684458)
,p_plug_template_id=>wwv_flow_imp.id(708360680175684458)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708361226794684458)
,p_plug_template_id=>wwv_flow_imp.id(708360680175684458)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708361553130684458)
,p_plug_template_id=>wwv_flow_imp.id(708360680175684458)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708361894389684458)
,p_plug_template_id=>wwv_flow_imp.id(708360680175684458)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708362135828684459)
,p_plug_template_id=>wwv_flow_imp.id(708360680175684458)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708362470666684459)
,p_plug_template_id=>wwv_flow_imp.id(708360680175684458)
,p_name=>'Sub Regions'
