...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56882916104800342521)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882916475571342521)
,p_plug_template_id=>wwv_flow_api.id(56882916104800342521)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882916702136342521)
,p_plug_template_id=>wwv_flow_api.id(56882916104800342521)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882917065042342521)
,p_plug_template_id=>wwv_flow_api.id(56882916104800342521)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882917361635342521)
,p_plug_template_id=>wwv_flow_api.id(56882916104800342521)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882917629703342521)
,p_plug_template_id=>wwv_flow_api.id(56882916104800342521)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882917998785342521)
,p_plug_template_id=>wwv_flow_api.id(56882916104800342521)
,p_name=>'Sub Regions'
