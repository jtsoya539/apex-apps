...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(708394211572684470)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708394577414684470)
,p_plug_template_id=>wwv_flow_imp.id(708394211572684470)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708394833806684470)
,p_plug_template_id=>wwv_flow_imp.id(708394211572684470)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708395171057684470)
,p_plug_template_id=>wwv_flow_imp.id(708394211572684470)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708395474588684470)
,p_plug_template_id=>wwv_flow_imp.id(708394211572684470)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708395754406684470)
,p_plug_template_id=>wwv_flow_imp.id(708394211572684470)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708396077505684470)
,p_plug_template_id=>wwv_flow_imp.id(708394211572684470)
,p_name=>'Sub Regions'
