...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57274403018549403697)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(57274403359357403697)
,p_plug_template_id=>wwv_flow_api.id(57274403018549403697)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(57274403681240403697)
,p_plug_template_id=>wwv_flow_api.id(57274403018549403697)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(57274403910505403697)
,p_plug_template_id=>wwv_flow_api.id(57274403018549403697)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(57274404277824403697)
,p_plug_template_id=>wwv_flow_api.id(57274403018549403697)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(57274404505742403698)
,p_plug_template_id=>wwv_flow_api.id(57274403018549403697)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(57274404842983403698)
,p_plug_template_id=>wwv_flow_api.id(57274403018549403697)
,p_name=>'Sub Regions'
