...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(708401646183684473)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708401955702684473)
,p_plug_template_id=>wwv_flow_imp.id(708401646183684473)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708402235176684473)
,p_plug_template_id=>wwv_flow_imp.id(708401646183684473)
,p_name=>'Sub Regions'
