...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(57274407240888403698)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(57274407534210403699)
,p_plug_template_id=>wwv_flow_api.id(57274407240888403698)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(57274407885283403699)
,p_plug_template_id=>wwv_flow_api.id(57274407240888403698)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(57274408133265403699)
,p_plug_template_id=>wwv_flow_api.id(57274407240888403698)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(57274408448542403699)
,p_plug_template_id=>wwv_flow_api.id(57274407240888403698)
,p_name=>'Sub Regions'
