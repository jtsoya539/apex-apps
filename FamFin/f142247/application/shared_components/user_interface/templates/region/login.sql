...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56882939984531342530)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882940211513342530)
,p_plug_template_id=>wwv_flow_api.id(56882939984531342530)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882940501549342530)
,p_plug_template_id=>wwv_flow_api.id(56882939984531342530)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882940809434342530)
,p_plug_template_id=>wwv_flow_api.id(56882939984531342530)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882941189537342530)
,p_plug_template_id=>wwv_flow_api.id(56882939984531342530)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882941454631342530)
,p_plug_template_id=>wwv_flow_api.id(56882939984531342530)
,p_name=>'Sub Regions'
