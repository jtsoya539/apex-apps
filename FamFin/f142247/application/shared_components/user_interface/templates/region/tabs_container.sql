...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(708436053798684485)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708436363172684485)
,p_plug_template_id=>wwv_flow_imp.id(708436053798684485)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708436628312684485)
,p_plug_template_id=>wwv_flow_imp.id(708436053798684485)
,p_name=>'Tabs'
