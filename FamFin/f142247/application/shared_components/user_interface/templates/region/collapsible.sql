...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(708384702112684467)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708385097515684467)
,p_plug_template_id=>wwv_flow_imp.id(708384702112684467)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708385342928684467)
,p_plug_template_id=>wwv_flow_imp.id(708384702112684467)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708385622629684467)
,p_plug_template_id=>wwv_flow_imp.id(708384702112684467)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708385936000684467)
,p_plug_template_id=>wwv_flow_imp.id(708384702112684467)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708386211435684467)
,p_plug_template_id=>wwv_flow_imp.id(708384702112684467)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708386593313684467)
,p_plug_template_id=>wwv_flow_imp.id(708384702112684467)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708386834062684467)
,p_plug_template_id=>wwv_flow_imp.id(708384702112684467)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708387115590684467)
,p_plug_template_id=>wwv_flow_imp.id(708384702112684467)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708387498686684467)
,p_plug_template_id=>wwv_flow_imp.id(708384702112684467)
,p_name=>'Sub Regions'
