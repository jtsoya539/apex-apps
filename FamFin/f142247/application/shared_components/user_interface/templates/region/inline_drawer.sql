...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(56882928157694342525)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882928455649342525)
,p_plug_template_id=>wwv_flow_api.id(56882928157694342525)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882928779712342525)
,p_plug_template_id=>wwv_flow_api.id(56882928157694342525)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882929016134342525)
,p_plug_template_id=>wwv_flow_api.id(56882928157694342525)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882929358407342525)
,p_plug_template_id=>wwv_flow_api.id(56882928157694342525)
,p_name=>'Delete'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882929649109342526)
,p_plug_template_id=>wwv_flow_api.id(56882928157694342525)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882929984793342526)
,p_plug_template_id=>wwv_flow_api.id(56882928157694342525)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882930217965342526)
,p_plug_template_id=>wwv_flow_api.id(56882928157694342525)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(56882930596548342526)
,p_plug_template_id=>wwv_flow_api.id(56882928157694342525)
,p_name=>'Sub Regions'
