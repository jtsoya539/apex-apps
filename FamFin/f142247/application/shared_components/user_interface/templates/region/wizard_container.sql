...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(708443447088684488)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708443717491684488)
,p_plug_template_id=>wwv_flow_imp.id(708443447088684488)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708444087112684488)
,p_plug_template_id=>wwv_flow_imp.id(708443447088684488)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708444337661684488)
,p_plug_template_id=>wwv_flow_imp.id(708443447088684488)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708444626312684488)
,p_plug_template_id=>wwv_flow_imp.id(708443447088684488)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(708444989570684488)
,p_plug_template_id=>wwv_flow_imp.id(708443447088684488)
